...
var (
	...
	ColorBrightRed = color.NRGBA{255, 0, 0, 255}
	ColorRedGlass  = color.NRGBA{203, 67, 53, 128}
	...
	ColorVeryDarkRed  = color.NRGBA{96, 0, 0, 255}
	ColorSmokedGlass  = color.NRGBA{8, 8, 8, 200}
	ColorNearBlack    = color.NRGBA{12, 12, 12, 255}
	ColorMilkGlass    = color.NRGBA{128, 128, 128, 32}
)
